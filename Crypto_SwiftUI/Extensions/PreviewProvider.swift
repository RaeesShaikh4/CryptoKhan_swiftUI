...
class DeveloperPreview {
    ...
    let stat1 = StatisticsModel(title: "Market Cap", value: "$14.5Bn",percentageChange: 25.34)
    let stat2 = StatisticsModel(title: "Total Volume", value: "$1.54Tr")
    let stat3 = StatisticsModel(title: "Portfolio Value", value: "$50.4k",percentageChange: -12.56)
